...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <h1>Secret Santa</h1>
        <p>
            <asp:Label ID="Label1" runat="server" Text="Hi there! This is BFF Secret Santa home page. To be able to play, please, select your "></asp:Label>
        </p>          
        <p>
            <asp:ListBox ID="ListBox1" runat="server" Width="491px"></asp:ListBox>
           <asp:RequiredFieldValidator ID="Value1RequiredValidator" ControlToValidate="ListBox1"
       ...
       <asp:UpdatePanel runat="server" ID="Update1" UpdateMode="Conditional">
        ...
        <Triggers><asp:AsyncPostBackTrigger ControlID="ListBox1" EventName="TextChanged" /></Triggers>
       </asp:UpdatePanel>
