...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <h1>Secret Santa</h1>
        <p>
            <asp:Label ID="Label1" runat="server" Text="Hi there! This is BFF Secret Santa home page. To be able to play, please, enter your russian name in full regular form."></asp:Label>
        </p>          
