...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        <div class="jumbotron">
            ...
            <p><asp:Label ID="Label3" runat="server" Text="Oh, please, remeber your choice, because you can see this page only once. This is due to technical limitations and for purpose of Art. Merry Christmas and a Happy New Year!"></asp:Label></p>
        </div>
</asp:Content>
